...
import { presentation as p252crm } from '@/components/detail/presentations/p25-2-dynamic-crm';
...
export const DATA: PortfolioData = {
  ...
  projects: [
    ...
    { id: "p25-2crm", title: "CRM Énergie (Projet Personnel)", cat: "Desktop", year: 2025, color: "#f7e57e", summary: "CRM pour courtiers en énergie B2B.", desc: "Application WPF complète de gestion de relation client pour le secteur énergétique. Gestion clients/prospects multi-sites, suivi commercial, comparaison tarifaire fournisseurs et alertes de relance.", highlights: ["WPF/MVVM", "EF Core 10", "PostgreSQL", "Métier Énergie"], tech: ["C#", "WPF", ".NET 10", "Entity Framework Core", "PostgreSQL"], presentation: p252crm },
  ...
  accomplishments: [
    ...
    },
    {
      ...
      shortDesc: "En Bachelor 3 à Ynov Campus, j'ai consolidé mon expertise C# / WPF chez Actulog tout en explorant les technologies web en parallèle, via les projets scolaires et personnels.",
      desc: "En Bachelor 3 à Ynov Campus, mon alternance chez Actulog était exclusivement centrée sur le développement C# / WPF / MVVM sur l'ERP Sigbox — c'est là que s'est construite ma vraie expertise logicielle.<br><br>En parallèle, via les projets scolaires et personnels, j'ai commencé à explorer le web : React pour un premier projet frontend, Angular pour les back-offices, et les bases de ASP.NET Core côté API. Ces apprentissages sont venus compléter ma stack, mais restent distincts de l'expérience professionnelle acquise en alternance."
    },
  ]
};
